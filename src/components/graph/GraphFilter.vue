<template>
  <div class="filter-panel">
    ...
    <el-checkbox-group 
      ...
      @update:model-value="(val: string[]) => $emit('update:visibleRelationTypes', val)"
      @change="$emit('change')"
    >
      <el-checkbox 
    ...
    <el-slider
      ...
      @update:model-value="(val: number | number[]) => $emit('update:importanceThreshold', Array.isArray(val) ? val[0] : val)"
      :min="0"
      :max="100"
